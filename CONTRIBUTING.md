...
1. **Pick the right home.** Group by protocol first (`mcp/`, `a2a/`, `agent-api/`),
   then by the problem the recipe solves (e.g. `mcp/authentication/`,
   `mcp/apps/`). Add a new problem folder if none fits.
