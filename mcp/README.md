...
| **Apps & UI** | [`apps-ui/drawio/`](apps-ui/drawio/) | Embedding an editable draw.io diagram editor inside the MCP client — no auth, fully client-side. |
| **Apps & UI** | [`apps-ui/servicenow/`](apps-ui/servicenow/) | An interactive record-creation form backed by ServiceNow, with OAuth + Dynamic Client Registration. |
